...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            String sql = "INSERT INTO kargo (gonderici_adsoyad, gonderici_tel, alici_adsoyad, alici_tel, kargo_turu, agirlik, gonderim_tarihi, tahmini_teslim_tarihi, adres, takip_no) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
